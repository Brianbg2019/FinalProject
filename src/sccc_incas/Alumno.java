...
public class Alumno extends javax.swing.JFrame {
    ...
    public void colortransparent(){
        ...
        txtn_nie.setBackground(new Color (0,0,0,0));        
    ...
    private void initComponents() {
        ...
        txtn_nie = new javax.swing.JTextField();
        ...
        txtn_nie.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        txtn_nie.setForeground(new java.awt.Color(255, 255, 255));
        txtn_nie.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtn_nie.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(255, 255, 255)));
        txtn_nie.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtn_nieActionPerformed(evt);
            }
        });
        txtn_nie.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtn_nieKeyTyped(evt);
            }
        });
        getContentPane().add(txtn_nie, new org.netbeans.lib.awtextra.AbsoluteConstraints(822, 266, 130, -1));

        txts.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txts.setForeground(new java.awt.Color(255, 255, 255));
        txts.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "\"A\"", "\"B\"", "\"C\"", "\"D\"", "\"E\"", "\"F\"", "\"G\"", "\"H\"", "\"J\"", "\"K\"", "\"L\"", "\"M\"", "\"N\"" }));
        txts.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        getContentPane().add(txts, new org.netbeans.lib.awtextra.AbsoluteConstraints(822, 315, -1, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Observaciones:");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 360, 110, -1));

        Scroll.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        ...
        getContentPane().add(Scroll, new org.netbeans.lib.awtextra.AbsoluteConstraints(765, 386, 240, 118));
        ...
        Fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Fondo_A.png"))); // NOI18N
    ...
    private void RegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistroActionPerformed
        ...
        String n_nie=txtn_nie.getText();
        String s = (String) txts.getSelectedItem();
        ...
        if(txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty() || txthora_i.getText().isEmpty()
           || txthora_f.getText().isEmpty() || txtfecha.getText().isEmpty() || txtrecurso_a.getText().isEmpty() || txtactividad_a.getText().isEmpty()
                || txtn_nie.getText().isEmpty()|| txtob.getText().isEmpty()){
        JOptionPane.showMessageDialog(null, "Es Obligatorio Llenar Todos Los Campos", "Error", JOptionPane.ERROR_MESSAGE);
        }else{
        Alumno_Datos alumno= new Alumno_Datos(nombre, apellido, hora_i, hora_f, fecha, recurso_a, actividad_a, n_nie, s, ob);
        try{
            Registrar_Alumnos r_alumno=new Registrar_Alumnos();
            r_alumno.guardaEstudiante(estudiante);
            JOptionPane.showMessageDialog(this,"Se Guardo Con Exito Los Datos Del Alumno "+nombre, "Informacion",JOptionPane.INFORMATION_MESSAGE);
            Salir S = new Salir();
            S.setVisible(true);
            dispose();
        }
    ...
    private void txtn_nieKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtn_nieKeyTyped
        // TODO add your handling code here:
        ...
        int nc=7;
        if(txtn_nie.getText().length()>nc){
            evt.consume();
            JOptionPane.showMessageDialog(rootPane,"Solo Se Permiten 8 Digitos" );
            
        }
    }//GEN-LAST:event_txtn_nieKeyTyped
    ...
    private void txtn_nieActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtn_nieActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtn_nieActionPerformed
    ...
    private javax.swing.JTextField txtn_nie;
