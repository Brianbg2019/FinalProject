 ...
 * @author desarrollo
 */
public class MINED extends javax.swing.JFrame {

    /**
     * Creates new form MINED
     */
    public MINED() {
        initComponents();
    ...
    public void colortransparent(){
        ...
        txtdui.setBackground(new Color (0,0,0,0));        
    ...
    private void initComponents() {
        ...
        txtdui.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(255, 255, 255)));
        ...
        getContentPane().add(txtdui, new org.netbeans.lib.awtextra.AbsoluteConstraints(822, 266, 130, -1));
        ...
        Fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Fondo_M.png"))); // NOI18N
    ...
    private void RegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistroActionPerformed
        ...
        if(txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty() || txthora_i.getText().isEmpty()
            ...
            || txtdui.getText().isEmpty()|| txtob.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Es Obligatorio Llenar Todos Los Campos", "Error", JOptionPane.ERROR_MESSAGE);

        }else{

            MINED_Datos MINED = new MINED_Datos(nombre, apellido, hora_i, hora_f, fecha, recurso_a, actividad_a, dui, ob);
            try{
                Registrar_MINED r_mined=new Registrar_MINED();
                r_mined.guardarMINED(MINED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MINED.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
