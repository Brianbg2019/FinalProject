...
import conexion_BD.Registrar_Otros;
...
public class Otros extends javax.swing.JFrame {
    ...
    private void RegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistroActionPerformed
        ...
        if(txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty() || txthora_i.getText().isEmpty()
            ...
            Otros_Datos Otros = new Otros_Datos(nombre, apellido, hora_i, hora_f, fecha, recurso_a, actividad_a, dui, ob);
            try{
                Registrar_Otros R_Otros=new Registrar_Otros();
                R_Otros.guardarOtros(Otros);
